...
// @mdouglasbrett - I originally tried to use BTreeMap's Iter as my IntoIter
// type which had different Item type. However the 'clue' was stated in the
// comment up top, we wanted to get back the actual tickets
