...
use std::error::Error;
use std::fmt::{Debug, Display, Error as FErr, Formatter};
...
impl Display for TicketNewError {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result<(), FErr> {
        match self {
...
fn easy_ticket(title: String, description: String, status: Status) -> Ticket {
    // @mdouglasbrett - they did want us to clone the args on the last one so am doing that here
